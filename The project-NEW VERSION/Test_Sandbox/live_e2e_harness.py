...
def run_live(harness: HarnessSystem):
    has_gaze = GazeTracker is not None
    if not has_gaze:
        print("UYARI: Gaze_Detection modülü bulunamadı. Yalnızca Speech (Ses) modülü test edilecek!")
    ...
    tracker = GazeTracker() if has_gaze else None
