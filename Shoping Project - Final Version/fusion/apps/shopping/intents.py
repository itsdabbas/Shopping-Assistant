...
# ── Vosk grammar vocabulary for the shopping demo ───────────────────
# Passed to SpeechAdapter(vosk_vocab=SHOPPING_VOSK_VOCAB) so that the
# toolkit core contains no shopping-specific strings.

SHOPPING_VOSK_VOCAB: list[str] = [
    # ADD_TO_CART variations (homophones + short forms recognised by ASR)
    "add to cart",
    "add",
    "cart",
    "card",
